...
<div className="card rounded">
      ...
      <div className="card-body">
        <div className="jumbotron bg-light border">
          <input type="text" name="" id="" placeholder="enter the title of the mintost:" style={{width:"100%", fontSize:"1.6em", padding:"0.4em"}}onChange=''/>
          <hr className="my-4" />
          <div className="border content-box">
            <textarea name="" id="" style={{width: "100%", padding:"0.75em", fontSize: "1.2em"}} rows="10" placeholder="Enter the content of your mintost" onChange=''></textarea>
          </div>
          <br />
          <div className="row">
            <div className="col-sm-3">
